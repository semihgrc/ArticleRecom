...
class ArticleVectorSB:
    def __init__(self, db_name='vectors', collection_name='article_vectorsSB'):
    ...
    def extract_and_update_titles(self, directory, num_articles=2000):
        ...
        return f"First {num_articles} SciBERT article titles extracted and updated in MongoDB successfully!"
